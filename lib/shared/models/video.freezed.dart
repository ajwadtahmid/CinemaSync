...
mixin _$Video {
 ...
 String get id; String get key; String get name; String get site; String get type; bool get official;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,key,name,site,type,official);

@override
String toString() {
  return 'Video(id: $id, key: $key, name: $name, site: $site, type: $type, official: $official)';
}
...
@useResult
$Res call({
 String id, String key, String name, String site, String type, bool official
});
...
/// Create a copy of Video
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? key = null,Object? name = null,Object? site = null,Object? type = null,Object? official = null,}) {
  return _then(Video(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String key,  String name,  String site,  String type,  bool official)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Video() when $default != null:
return $default(_that.id,_that.key,_that.name,_that.site,_that.type,_that.official);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String key,  String name,  String site,  String type,  bool official)  $default,) {final _that = this;
switch (_that) {
case _Video():
return $default(_that.id,_that.key,_that.name,_that.site,_that.type,_that.official);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String key,  String name,  String site,  String type,  bool official)?  $default,) {final _that = this;
switch (_that) {
case _Video() when $default != null:
return $default(_that.id,_that.key,_that.name,_that.site,_that.type,_that.official);case _:
  return null;
...
class _Video extends Video {
  const _Video({required this.id, required this.key, required this.name, required this.site, required this.type, this.official = false}): super._();
...
/// Create a copy of Video
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? key = null,Object? name = null,Object? site = null,Object? type = null,Object? official = null,}) {
  return _then(_Video(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,key: null == key ? _self.key : key // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
